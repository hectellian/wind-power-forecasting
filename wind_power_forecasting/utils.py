...
data_dir = "./data/wtbdata_245days.csv"
relative_position_file = "./data/sdwpf_baidukddcup2022_turb_location.CSV"
...
def download_data(url: str, filename: str):
    ...
    if not os.path.exists(filename):
        ...
        with tqdm(unit="B", unit_scale=True, miniters=1, desc=f"Downloading {filename}...") as progress_bar:
